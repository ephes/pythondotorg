...
from sponsors.forms import (
    ...
    SponsorEmailNotificationTemplateForm,
)
...
class SponsorEmailNotificationTemplateFormTests(TestCase):
    ...
    def test_validate_required_fields(self):
        ...
        form = SponsorEmailNotificationTemplateForm(data={})
        self.assertFalse(form.is_valid())
        self.assertEqual(required, set(form.errors))

    def test_validate_with_correct_data(self):
        form = SponsorEmailNotificationTemplateForm(data=self.data)
