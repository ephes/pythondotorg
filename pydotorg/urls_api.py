...
urlpatterns = [
    path('sponsors/logo-placement/', LogoPlacementeAPIList.as_view(), name="logo_placement_list"),
    path('sponsors/sponsorship-assets/', SponsorshipAssetsAPIList.as_view(), name="assets_list"),
]
